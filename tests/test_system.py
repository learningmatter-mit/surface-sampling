...
def test_surface_system_constraint_retention(si_slab, test_calculator):
    ...
    unchanged_relaxed_constraints = unchanged.relaxed_atoms.constraints[0].todict()[
        "kwargs"
    ]["indices"]
...
def test_surface_system_constraint_setting(si_slab, test_calculator):
    ...
    relaxed_constraints = partially_constrained.relaxed_atoms.constraints[0].todict()[
        "kwargs"
    ]["indices"]
